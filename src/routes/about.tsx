  ...
  head: () => ({
    meta: [
      { title: "About Ntarakwai: Conservation-Driven Beekeeping on Mt. Kulal" },
      {
        name: "description",
        content:
          "The story of Ntarakwai Beekeeping Limited: founder Ledany Timothy, Mt. Kulal in Marsabit County, our mission, vision, core values and where we are heading.",
      },
      { property: "og:title", content: "About Ntarakwai Beekeeping Limited" },
      {
        property: "og:description",
        content:
          "A conservation-driven honey company born on Mt. Kulal, Loiyangalani Ward, Marsabit County.",
      },
  ...
  return (
    <>
      <PageHero
        ...
        title={
          <>
            A company that began with a boy, a hive, and a <em className="text-honey">mountain</em>.
          </>
        }
      ...
      >
        <Link to="/shop" className="btn-honey">
          <ShoppingBag className="h-4 w-4" /> Shop the harvest
        </Link>
      </PageHero>
        ...
        <div className="container-luxe grid gap-16 lg:grid-cols-[1.15fr_1fr] lg:items-start">
          <div className="reveal-slow">
            ...
            <p className="dropcap mt-7 text-lg leading-relaxed text-muted-foreground">
              He grew up around Mt. Kulal, in a place where honey has always been part of life. What
              struck him early was the contradiction: the region produces exceptional honey; the
              biodiversity and untouched environment see to that; and yet the people harvesting it
              had nowhere consistent to sell.
            </p>
            <p className="mt-5 text-lg leading-relaxed text-muted-foreground">
              A trader might come. A price might be offered. Neither was reliable enough to build a
              household around. Good honey was routinely sold for less than it was worth, or not
              sold at all.
            </p>
            <p className="mt-5 text-lg leading-relaxed text-muted-foreground">
              So rather than starting another honey business, he set out to build something that
              solved several problems at once: produce authentic, high-quality honey; create a
              sustainable market for local beekeepers; promote environmental conservation; generate
              employment for local youth; protect Mt. Kulal's unique ecosystem; and build a
              nationally recognised premium honey brand out of all of it.
            </p>
            <p className="mt-5 text-lg leading-relaxed text-muted-foreground">
              {BRAND.legalName} was registered as a limited company in {BRAND.registered}, and
              operates from its honey shop in {BRAND.shop}.
            </p>
          </div>
          ...
          <div className="reveal-slow space-y-6">
            <div className="overflow-hidden rounded-[2rem] shadow-[var(--shadow-luxe)]">
              <img
                src={beekeeper}
                alt="Working a hive on the slopes of Mt. Kulal"
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                    Two apiaries on the mountain, one honey shop in Gatab, and a network of
                    gatherers across the surrounding slopes.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="grid gap-14 lg:grid-cols-2 lg:items-center">
          <div className="reveal-slow">
            ...
            <p className="mt-7 text-lg leading-relaxed text-cream/75">
              Mt. Kulal stands in northern Kenya's dry lands, catching cloud and holding a belt of
              indigenous forest that has no equivalent nearby. Its biodiversity and its distance
              from farmland are exactly why the honey is what it is.
            </p>
            <p className="mt-5 text-lg leading-relaxed text-cream/75">
              Bees forage on wild, unsprayed vegetation. No monoculture flattens the flavour, and no
              agricultural chemistry follows it into the comb. Season by season, the honey carries
              whatever the mountain chose to flower.
            </p>
          </div>
          <div className="reveal-slow overflow-hidden rounded-[2.5rem]">
            <img
              src={apiary}
              alt="Hives sited on a rocky slope of Mt. Kulal"
              className="h-full w-full object-cover"
              loading="lazy"
              width={1600}
              height={1104}
      ...
      <section className="bg-background py-24 md:py-32">
        <div className="container-luxe grid gap-6 md:grid-cols-2">
          {[
            ...
            <div
              key={b.title}
              className="reveal-slow rounded-[2rem] border border-border bg-card p-10 shadow-sm md:p-12"
      ...
      <section className="bg-secondary/50 py-24 md:py-32">
        <div className="container-luxe">
          <SectionHead
            ...
            title={
              <>
                Nine things we are not willing to <em className="text-honey-deep">trade away</em>.
              </>
            }
          />
          <div className="mt-16 grid gap-px overflow-hidden rounded-[2rem] border border-border bg-border sm:grid-cols-2 lg:grid-cols-3">
            {VALUES.map((v, i) => (
              <div
                key={v.title}
                className="reveal-slow bg-card p-8"
                style={{ transitionDelay: `${(i % 3) * 90}ms` }}
              >
                <div className="font-display text-xs uppercase tracking-[0.24em] text-honey-deep">
      ...
      <section className="bg-background py-24 md:py-32">
        <div className="container-luxe grid gap-14 lg:grid-cols-2 lg:items-center">
          <div className="reveal-slow overflow-hidden rounded-[2.5rem] shadow-[var(--shadow-luxe)]">
            <img
              src={community}
              alt="Local beekeepers in a training session near Mt. Kulal"
              className="h-full w-full object-cover"
              loading="lazy"
              width={1600}
              height={1104}
          ...
          <div className="reveal-slow">
            ...
            <h2 className="font-display mt-4 text-4xl leading-[1.06] text-charcoal md:text-5xl">
              We buy from more than thirty{" "}
              <em className="text-honey-deep">independent beekeepers</em>.
            </h2>
            <p className="mt-7 text-lg leading-relaxed text-muted-foreground">
              Our own 55 hives are only part of the story. Purchasing honey from local gatherers
              creates income for communities that previously lacked reliable markets, and our
              continuous training raises both the quality of their harvest and what it can earn.
            </p>
      ...
      <section className="bg-charcoal py-24 text-cream md:py-32">
        <div className="container-luxe">
          <SectionHead
            ...
            title={
              <>
                A young company with a long <em className="text-honey">horizon</em>.
              </>
            }
          ...
          <div className="mt-16 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {AMBITIONS.map((a, i) => (
              ...
              >
                <div className="font-display text-3xl text-honey/70">
                  {String(i + 1).padStart(2, "0")}
                </div>
      ...
      <ParallaxBand
        ...
        alt=""
        speed={0.12}
        overlay="from-charcoal/90 via-charcoal/78 to-charcoal/60"
      >
        <div className="flex flex-col items-start gap-8 py-24 md:flex-row md:items-center md:justify-between">
          <div className="reveal max-w-2xl">
            <h2 className="font-display text-4xl leading-tight text-cream md:text-5xl">
              Come and see the mountain for yourself.
            </h2>
            <p className="mt-4 text-cream/75">
              Visit the honey shop in Gatab, or speak with our team about orders, wholesale and
              partnerships.
            </p>
          </div>
