  ...
  head: () => ({
    meta: [
      { title: "Wholesale Honey Supply: Retailers, Hotels & Distributors" },
      {
        name: "description",
        content:
          "Reliable bulk supply of premium honey and bee products for supermarkets, hotels, restaurants and distributors.",
      },
      { property: "og:title", content: "Ntarakwai Wholesale" },
  ...
  return (
    <>
      <PageHero
        ...
        title={
          <>
            Bulk supply with <em className="text-honey">unwavering quality</em>.
          </>
        }
      ...
      >
        <a href="tel:+254711856795" className="btn-honey">
          <Phone className="h-4 w-4" /> +254 711 856 795
        </a>
      </PageHero>
        ...
        <div className="container-luxe">
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div
                key={p.t}
                className="reveal rounded-3xl border border-border bg-card p-7 text-center shadow-sm"
                style={{ transitionDelay: `${i * 60}ms` }}
              >
                <span className="mx-auto grid h-14 w-14 place-items-center rounded-2xl bg-honey/20 text-honey-deep">
      ...
      <section className="bg-secondary/60 py-24">
        <div className="container-luxe grid items-center gap-14 md:grid-cols-2">
          <img
            src={gift}
            alt="Premium honey gift box"
            className="reveal rounded-[2rem] shadow-[var(--shadow-card)]"
            loading="lazy"
            width={896}
            height={1152}
          />
            ...
            <ul className="mt-8 space-y-4">
              {[
                ...
                <li key={b} className="flex items-start gap-3 text-foreground">
                  <span className="mt-0.5 grid h-6 w-6 shrink-0 place-items-center rounded-full bg-honey text-charcoal">
        ...
        <div className="container-luxe grid gap-12 md:grid-cols-2">
          <div className="reveal">
            ...
            <p className="mt-4 max-w-md text-muted-foreground">
              Share your volume, packaging and timeline. Our team will respond within one business
              day.
            </p>
            ...
            {sent ? (
              <div className="grid h-full place-items-center py-16 text-center">
                <div>
                  ...
                  <h3 className="font-display mt-5 text-2xl text-charcoal">
              ...
              <div className="grid gap-4">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <Field
                    ...
                    name="volume"
                    placeholder="e.g. 200 jars / month"
                  />
                </div>
                <label className="text-sm font-medium text-charcoal">
                  ...
                  <textarea
                    ...
                    name="message"
                    rows={4}
                    className="mt-1.5 w-full rounded-2xl border border-input bg-background px-4 py-3 text-sm outline-none transition focus:border-honey-deep focus:ring-2 focus:ring-honey/30"
                  />
                </label>
                <button type="submit" className="btn-honey mt-2 w-full">
                  Request quotation
                </button>
              </div>
            )}
