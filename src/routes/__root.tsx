...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Nyarakwai Beekeeping limmited — Premium Honey & Bee Products" },
      ...
      { name: "author", content: "Nyarakwai Beekeeping limmited" },
      { property: "og:title", content: "Nyarakwai Beekeeping limmited — Premium Honey & Bee Products" },
      ...
      { name: "twitter:title", content: "Nyarakwai Beekeeping limmited — Premium Honey & Bee Products" },
