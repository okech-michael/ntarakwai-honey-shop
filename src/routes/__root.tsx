...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Nyarakwai Beekeeping Limited — Premium Honey & Bee Products" },
      ...
      { name: "author", content: "Nyarakwai Beekeeping Limited" },
      { property: "og:title", content: "Nyarakwai Beekeeping Limited — Premium Honey & Bee Products" },
      ...
      { name: "twitter:title", content: "Nyarakwai Beekeeping Limited — Premium Honey & Bee Products" },
