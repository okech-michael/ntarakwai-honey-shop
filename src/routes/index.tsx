  ...
  head: () => ({
    meta: [
      { title: "Ntarakwai Beekeeping: Raw Honey from Mt. Kulal, Marsabit" },
      {
        name: "description",
        content:
          "Conservation-driven beekeeping on Mt. Kulal. Raw honey and beeswax from 55 hives and 30+ local gatherers in Loiyangalani Ward, Marsabit County, Kenya.",
      },
      { property: "og:title", content: "Ntarakwai Beekeeping: Honey with a homeland" },
      {
        property: "og:description",
        content:
          "Raw honey and beeswax from the forests of Mt. Kulal, produced with the community that protects them.",
      },
...
function Home() {
  ...
  return (
    <>
      ...
      <section
        ref={heroRef}
        className="grain relative h-[100svh] min-h-[660px] w-full overflow-hidden"
      >
          ...
          {Array.from({ length: 20 }).map((_, i) => (
            <span
              ...
              style={{
                left: `${(i * 53) % 100}%`,
                bottom: "-20px",
                animation: `drift ${10 + (i % 7)}s linear ${i * 0.7}s infinite`,
              }}
            />
          ))}
        </div>
        ...
        <div
          className="container-luxe relative z-10 flex h-full flex-col items-start justify-end pb-24 pt-32 md:justify-center md:pb-0"
          data-hero-text
        >
          ...
          <p className="mt-8 max-w-xl text-base leading-relaxed text-cream/85 md:text-lg">
            High on a mountain in northern Kenya, wild forest flowers become raw honey, harvested by
            the people who have always lived beside these bees, and who now have a market worthy of
            it.
          </p>
        ...
        <div className="container-luxe grid items-center gap-16 lg:grid-cols-[1.05fr_1fr]">
          <div className="reveal-slow relative">
            <div className="overflow-hidden rounded-[2.5rem] shadow-[var(--shadow-luxe)]">
              <img
                src={mtKulal}
                alt="Mist rolling over the forested ridge of Mt. Kulal at dawn"
          ...
          <div className="reveal-slow">
            ...
            <p className="dropcap mt-7 text-lg leading-relaxed text-muted-foreground">
              Mt. Kulal rises out of the dry lands east of Lake Turkana, catching cloud where
              everything below is heat and stone. That single act of geography creates a pocket of
              biodiversity found nowhere else in the region, an untouched, unfarmed landscape of
              indigenous trees and seasonal blossom.
            </p>
            <p className="mt-5 text-lg leading-relaxed text-muted-foreground">
              Bees here forage on a floral mix no one planted and no one sprays. It is the reason
              the honey tastes the way it does, and the reason we treat conservation as part of
              production rather than a slogan beside it.
            </p>
            <Link
              to="/sustainability"
              className="mt-9 inline-flex items-center gap-2 text-sm font-semibold text-honey-deep hover:underline"
            >
      ...
      <ParallaxBand
        ...
        overlay="from-charcoal/90 via-charcoal/78 to-charcoal/92"
      >
        <SectionHead
          tone="light"
          ...
          title={
            <>
              Six stages between a <em className="text-honey">blossom</em> and your table.
            </>
          }
        ...
        <div className="reveal mt-12 text-center">
          <Link to="/process" className="btn-honey">
            Walk the full process <ArrowRight className="h-4 w-4" />
          </Link>
        </div>
      </ParallaxBand>
        ...
        <div className="container-luxe grid items-center gap-16 lg:grid-cols-2">
          <div className="reveal-slow order-2 lg:order-1">
            ...
            <h2 className="font-display mt-4 text-4xl leading-[1.06] text-charcoal md:text-5xl">
              Thirty-plus harvests that used to have{" "}
              <em className="text-honey-deep">nowhere to go</em>.
            </h2>
            <p className="mt-7 text-lg leading-relaxed text-muted-foreground">
              Around Mt. Kulal, honey gathering is old knowledge. What was missing was a buyer: a
              consistent, fair, structured market. Families would harvest exceptional honey and then
              watch it sit.
            </p>
            <p className="mt-5 text-lg leading-relaxed text-muted-foreground">
              Ntarakwai buys from more than thirty independent beekeepers, and trains them in
              harvesting techniques that raise both quality and the price their honey can command.
              Their harvest is not a supply line to us. It is the point.
            </p>
            <div className="mt-9 flex flex-wrap gap-3">
              <Link to="/community" className="btn-honey">
                Community impact <ArrowRight className="h-4 w-4" />
              </Link>
              <Link to="/team" className="btn-outline-honey">
                Meet the team
              </Link>
            </div>
          </div>
          <div className="reveal-slow order-1 overflow-hidden rounded-[2.5rem] shadow-[var(--shadow-luxe)] lg:order-2">
            <img
              src={community}
              alt="A beekeeping training session with local gatherers around Mt. Kulal"
              className="h-full w-full object-cover"
              loading="lazy"
              width={1600}
              height={1104}
      ...
      <section className="relative overflow-hidden bg-background py-28 md:py-36">
        ...
        <div className="container-luxe relative">
          <SectionHead
            ...
            title={
              <>
                Most honey has a brand. Ours has an <em className="text-honey-deep">address</em>.
              </>
            }
          ...
          <div className="mt-16 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {[
              {
                icon: Mountain,
                t: "Single-origin, singular place",
                b: "Every jar traces back to Mt. Kulal: one mountain, two apiaries, one honey shop in Gatab.",
              },
              {
                icon: Leaf,
                t: "Wild forage, never farmed",
                b: "Bees feed on indigenous, unsprayed vegetation. No monoculture, no agricultural chemistry.",
              },
              {
                icon: Users,
                t: "A market, not an extraction",
                b: "Buying from 30+ local gatherers turns a harvest into a livelihood instead of a surplus.",
              },
              {
                icon: TreePine,
                t: "Conservation is the business model",
                b: "Bees need forest. Protecting Mt. Kulal's ecosystem is how we protect production.",
              },
              {
                icon: ShieldCheck,
                t: "Raw, carefully handled",
                b: "Processing, packaging and food-safety standards overseen in-house at Gatab.",
              },
              {
                icon: HandHeart,
                t: "Youth and women included",
                b: "Employment and training aimed squarely at the young people of Loiyangalani Ward.",
              },
            ].map((f, i) => (
              <div
                key={f.t}
      ...
      <ParallaxBand
        ...
        overlay="from-charcoal/92 via-charcoal/80 to-charcoal/92"
      >
        <SectionHead
          tone="light"
          ...
          title={
            <>
              A young company, counted <em className="text-honey">honestly</em>.
            </>
          }
      ...
      <section className="bg-background py-28 md:py-36">
        <div className="container-luxe">
          <SectionHead
            ...
            title={
              <>
                Opening the jar is the <em className="text-honey-deep">last stage</em> of the
                journey.
              </>
            }
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-3">
            {[
              {
                n: "Crystals are a good sign",
                b: "Raw honey granulates over time. Stand the jar in warm water and it returns to liquid, pasteurised honey never does this.",
              },
              {
                n: "The flavour shifts by season",
                b: "Each harvest reflects what was flowering. Colour and taste vary between batches, and we do not blend that away.",
              },
              {
                n: "It travels well",
                b: "Sealed, packed and dispatched by courier from Marsabit County to customers across Kenya.",
              },
            ].map((c, i) => (
          ...
          <figure className="reveal-slow mx-auto mt-20 max-w-3xl text-center">
            ...
            <blockquote className="font-display mt-6 text-2xl leading-relaxed text-charcoal md:text-3xl">
              "I started keeping bees at fifteen. The honey here was always exceptional; what we
              lacked was somewhere for it to go.”
            </blockquote>
            <figcaption className="mt-6 text-sm text-muted-foreground">
              <span className="font-semibold text-charcoal">{BRAND.founder}</span> · Founder &amp;
              Director
            </figcaption>
          </figure>
        </div>
      ...
      <section className="bg-charcoal py-28 text-cream md:py-36">
        <div className="container-luxe grid items-center gap-16 lg:grid-cols-2">
          <div className="reveal-slow overflow-hidden rounded-[2.5rem]">
            <img
              src={forest}
              alt="Indigenous cloud forest on the upper slopes of Mt. Kulal"
              className="h-full w-full object-cover"
              loading="lazy"
              width={1600}
              height={1104}
          ...
          <div className="reveal-slow">
            ...
            <p className="mt-7 text-lg leading-relaxed text-cream/75">
              Every hive on Mt. Kulal is an argument for keeping the forest standing. Beekeeping
              gives the community an income that depends on intact vegetation rather than on
              clearing it, which makes conservation the rational choice, not the sacrificial one.
            </p>
            ...
            <Link to="/sustainability" className="btn-honey mt-10">
              Read our conservation work <ArrowRight className="h-4 w-4" />
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="bg-secondary/50 py-28 md:py-36">
        <div className="container-luxe">
          <SectionHead
            ...
            title={
              <>
                Carry a piece of the <em className="text-honey-deep">mountain</em> home.
              </>
            }
              ...
              >
                <div className="relative aspect-[4/5] overflow-hidden bg-beige">
                  <img
                    ...
                    height={1152}
                  />
                  <span className="absolute left-4 top-4 rounded-full bg-cream/90 px-3 py-1 text-[10px] font-semibold uppercase tracking-widest text-honey-dark">
                    {p.tag}
                  </span>
                </div>
      ...
      <ParallaxBand
        ...
        alt=""
        speed={0.12}
        overlay="from-charcoal/92 via-charcoal/80 to-charcoal/60"
      >
        <div className="flex flex-col items-start gap-8 py-24 md:flex-row md:items-center md:justify-between md:py-28">
          <div className="reveal max-w-2xl">
            ...
            <p className="mt-5 text-cream/75">
              Every order supports gatherers around Mt. Kulal and the ecosystem their bees depend
              on. Delivered anywhere in Kenya.
            </p>
          </div>
          <div className="reveal flex flex-wrap gap-3">
            <Link to="/shop" className="btn-honey text-base">
