  ...
  head: () => ({
    meta: [
      { title: "Shop Premium Natural Honey Online: Ntarakwai" },
      {
        name: "description",
        content:
          "Order pure honey, beeswax, propolis, bee pollen and honey gift packs online. Delivery anywhere in Kenya via Via Wells Fargo or Nationwide delivery via your preferred parcel courier.",
      },
      { property: "og:title", content: "Shop Premium Natural Honey Online" },
      {
        property: "og:description",
        content:
          "Pure honey harvested naturally and delivered directly to your doorstep anywhere in Kenya.",
      },
  ...
  return (
    <>
      <PageHero
        ...
        title={
          <>
            Shop Premium <em className="text-honey">Natural Honey</em> Online
          </>
        }
        ...
        <div className="container-luxe grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            { icon: ShieldCheck, t: "Secure Checkout", s: "M-Pesa & Bank pay" },
            {
              ...
              s: "Via Wells Fargo or your preferred parcel courier",
            },
            { icon: Star, t: "Loved in Kenya", s: "5-star reviews" },
          ].map((f) => (
            <div key={f.t} className="flex items-center gap-3">
              <span className="grid h-11 w-11 place-items-center rounded-2xl bg-honey/20 text-honey-deep">
      ...
      <section className="bg-secondary/50 py-20">
        <div className="container-luxe">
          <div className="reveal mx-auto max-w-2xl text-center">
            <span className="text-xs font-semibold uppercase tracking-[0.25em] text-honey-deep">
              Shop by category
            </span>
            <h2 className="font-display mt-3 text-4xl text-charcoal md:text-5xl">
              Pure honey & hive treasures
            </h2>
          </div>
        ...
        <div className="container-luxe">
          <div className="reveal flex flex-wrap items-end justify-between gap-4">
            <div>
              ...
              <h2 className="font-display mt-2 text-4xl text-charcoal md:text-5xl">
                Our most-loved jars
              </h2>
            </div>
            <Link
              to="/shop/products"
              className="inline-flex items-center gap-2 text-sm font-semibold text-honey-deep hover:underline"
            >
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <Link
                    ...
                    params={{ slug: p.slug }}
                    className="font-display mt-1 block text-xl text-charcoal hover:text-honey-deep"
                  >
                    {p.name}
                  </Link>
                  <div className="mt-3 flex items-center justify-between">
                    <div>
                      <div className="font-display text-lg text-honey-deep">
                        {formatKES(p.price)}
                      </div>
                      {p.oldPrice && (
      ...
      <section className="bg-charcoal py-16 text-cream">
        <div className="container-luxe flex flex-col items-start gap-6 md:flex-row md:items-center md:justify-between">
          <div className="flex items-center gap-5">
            <span className="grid h-14 w-14 place-items-center rounded-2xl bg-honey text-charcoal">
              <Truck className="h-6 w-6" />
            </span>
            <div>
              <h3 className="font-display text-2xl md:text-3xl">
                Nationwide delivery via Via Wells Fargo or your preferred parcel courier
              </h3>
              <p className="mt-1 text-sm text-cream/70">
                Order today, dispatched within 24 hours. Delivery to all 47 counties.
              </p>
            </div>
          </div>
          <Link to="/shop/products" className="btn-honey">
