...
export const VALUES = [
  {
    title: "Authenticity",
    body: "What is on the label is what is in the jar. Nothing added, nothing hidden.",
  },
  {
    title: "Pure natural products",
    body: "Raw honey and beeswax, handled gently so the mountain's character survives the journey.",
  },
  {
    title: "Environmental conservation",
    body: "Bees only thrive where the forest does. Protecting Mt. Kulal's ecosystem is part of the work.",
  },
  {
    title: "Community empowerment",
    body: "A structured, reliable market for gatherers who previously had none.",
  },
  {
    title: "Transparency",
    body: "Open about where honey comes from, who harvested it, and what we paid.",
  },
  {
    title: "Sustainability",
    body: "Harvesting only surplus, so colonies and the landscape keep giving.",
  },
  {
    title: "Quality",
    body: "Careful processing, packaging standards and food safety discipline on every batch.",
  },
  {
    title: "Youth employment",
    body: "Work and training for young people from Loiyangalani and the wider ward.",
  },
  {
    title: "Responsible growth",
    body: "Growing at the pace the mountain, the bees and the community can carry.",
  },
] as const;
...
export const TEAM = [
  ...
  },
  {
    ...
    duties: [
      "Apiary operations",
      "Hive management and colony health",
...
export const SUPPORT_ROLES = [
  {
    title: "Honey Processing & Packaging Assistant",
    note: "Casual role supporting the processing bench in Gatab.",
  },
...
export const AMBITIONS = [
  {
    title: "A recognised premium brand",
    body: "Build Ntarakwai into a nationally recognised premium honey brand carrying the name of Mt. Kulal.",
  },
  {
    title: "More hives, more colonies",
    body: "Grow production steadily as more hives become colonised across the apiaries.",
  },
  {
    title: "A wider gatherer network",
    body: "Extend structured market access and training beyond the current thirty-plus beekeepers.",
  },
  {
    title: "Eco-tourism on the mountain",
    body: "Open Mt. Kulal to visitors who want to see conservation-driven beekeeping first-hand.",
  },
  {
    title: "A centre for research",
    body: "Make Mt. Kulal a recognised centre for sustainable beekeeping, conservation and research.",
  },
  {
    title: "Employment for local youth",
    body: "Turn a growing operation into steady, skilled work for young people in Loiyangalani Ward.",
  },
] as const;
